...
import { ProductsClient } from "@repo/ui/components/ProductsClient";
import { getCatalogProducts, getCatalogCategories } from "@repo/lib/dealio/catalog";
                ...
                <main className="pt-20 pb-12">
                    <div className="container mx-auto px-4 text-center py-24">
                        ...
                        <p className="text-muted-foreground">
                            Our catalog is temporarily unavailable. Please try
                            again in a moment.
                        </p>
                    </div>
                </main>
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="text-center mb-12">
                        ...
                        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                            Discover our complete collection of artisan breads,
                            pastries, and desserts, all made fresh daily with
