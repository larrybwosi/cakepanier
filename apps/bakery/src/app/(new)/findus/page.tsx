...
export default function FindUs() {
  return (
    <div className={`${notoSerif.variable} ${plusJakarta.variable} font-sans bg-[#fdf9f0] text-[#1c1c17] min-h-screen`}>
      {/* HEADER */}
      <header className="max-w-7xl mx-auto px-6 py-6 flex flex-col md:flex-row items-center justify-between gap-6 border-b border-[#dbc2b0]/20 mb-12">
        ...
        <button className="bg-[#8f4900] text-white px-6 py-2 rounded-md font-medium text-sm hover:opacity-90 transition-opacity">
          Order Now
        </button>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-6 mb-20">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-10 mb-12">
          <div className="max-w-2xl">
            ...
            <h1 className="text-5xl md:text-7xl font-serif text-[#1c1c17] leading-[1.1]">
              Where the dough <br /> rises daily.
            </h1>
          </div>
          <div className="lg:max-w-sm border-l-2 border-[#8f4900]/30 pl-6 pb-2">
            <p className="italic text-[#1c1c17]/70 font-serif text-xl leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-4 flex flex-col gap-6">
            ...
            <div className="bg-[#f1eee5] rounded-xl p-8">
            ...
            <div className="bg-[#f1eee5] rounded-xl p-8">
              ...
              <div className="space-y-6 text-sm">
                <div className="flex gap-4 items-start">
                  <div className="bg-[#e5dfd1] p-2 rounded-md text-[#8f4900]">
            ...
            <div className="bg-[#f1eee5] rounded-xl p-8">
              ...
              <div className="bg-[#fdf9f0] p-4 rounded-md flex gap-3 items-start border border-[#dbc2b0]/30">
                <div className="font-bold text-[#1c1c17] mt-0.5">P</div>
                <div>
          ...
          <div className="lg:col-span-8 bg-[#e8ece3] rounded-xl overflow-hidden relative min-h-125">
            {/* Map styling placeholder via background overlay */}
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
              <div className="bg-[#8f4900] text-white text-xs font-bold px-4 py-2 rounded-md shadow-lg mb-2">
                Artisanal Flourish
              </div>
      ...
      {/* NEWSLETTER SECTION - Using a lower container surface per the design doc */}
      <section className="bg-[#f7f3ea] py-24 px-6 text-center border-t border-[#dbc2b0]/20">
        <h2 className="font-serif text-[#1c1c17] text-3xl md:text-4xl mb-4 font-bold">Join our weekly loaf list.</h2>
        <p className="text-[#1c1c17]/70 text-sm max-w-md mx-auto mb-8">
        ...
        <div className="flex justify-center gap-3 max-w-md mx-auto">
          <input
            ...
            className="flex-1 bg-[#e5e2d8] rounded-md px-4 py-3 outline-none text-sm placeholder:text-[#1c1c17]/50 focus:ring-2 focus:ring-[#60613c]/30 transition-all"
          />
          <button className="bg-[#8f4900] text-white px-8 py-3 rounded-md font-bold text-sm hover:opacity-90 transition-opacity">
            Subscribe
          </button>
        </div>
      </section>
